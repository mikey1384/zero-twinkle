...
async function summarizeMemories() {
  ...
  try {
    ...
    const isSummarizedPromptRes = await openai.createCompletion({
      ...
      prompt: `When you enter a prompt, I am going to summarize it to 3 or fewer sentences. If there's nothing more to summarize, I'll just repeat what you said. Enter your prompt here: \n\n${prompt}\n\n\n`,
      temperature: 0.7,
      max_tokens: 3000,
      top_p: 1,
      frequency_penalty: 0,
    ...
    const isSummarizedResponseRes = await openai.createCompletion({
      model: "text-davinci-003",
      prompt: `When you enter a response, I am going to summarize it to 3 or fewer sentences. If there's nothing more to summarize, I'll just repeat what you said. Enter your response here: \n\n${response}\n\n\n`,
      temperature: 0.7,
      max_tokens: 3000,
      top_p: 1,
      frequency_penalty: 0,
